    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            ...
            <form id="contact" action="{{route('work-experience.update',$work->id)}}"
                ...
                <h3>فرم اصلاح تجارب کاری</h3>
                <h4>اطلاعات این فرم در صفحه ایندکس شما نمایش داده میشود</h4>

                <div class="form-group{{ $errors->has('title') ? ' has-error': ''}}">
                    <fieldset>
                        <input placeholder="نام شغل" type="text" value="{{$work->title}}" name="title" tabindex="1"
                               required autofocus>
                    </fieldset>
                    @if($errors->has('title'))
                ...
                <div class="form-group{{ $errors->has('company') ? ' has-error': ''}}">
                    <fieldset>
                        <input placeholder="شرکت" type="text" name="company" value="{{$work->company}}" tabindex="1"
                               required autofocus>
                    </fieldset>
                ...
                <div class="col-xs-6 pull-right">
                    <div class="form-group{{ $errors->has('start_date') ? ' has-error': ''}}">
                        <fieldset>
                            ...
                            <input name="start_date" class="input-small datepicker4" value="{{$work->start_date}}"
                                   type="text">
                        </fieldset>
                ...
                <div class="col-xs-6 pull-right">
                    <div class="form-group{{ $errors->has('finish_date') ? ' has-error': ''}}">
                        <fieldset>
                            ...
                            <input name="finish_date" class="input-small datepicker4" value="{{$work->finish_date}}"
                                   type="text">
                        </fieldset>
                ...
                <div class="form-group{{ $errors->has('about') ? ' has-error': ''}}">
                    <fieldset>
                        <input placeholder="توضیحات" value="{{$work->about}}" type="text" name="about" tabindex="1"
                               required autofocus>
                    </fieldset>
                    @if($errors->has('about'))
