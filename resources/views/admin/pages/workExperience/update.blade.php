        ...
        <div class="container">
            ...
            <form id="contact" action="{{route('work-experience.update',$work->id)}}"
                ...
                <div class="form-group{{ $errors->has('title') ? ' has-error': ''}}">
                    <fieldset>
                        <input class="form-control m-b col-md-3" placeholder="نام شغل" type="text" value="{{$work->title}}" name="title" tabindex="1"
                               required autofocus>
                    </fieldset>
                    @if($errors->has('title'))
                ...
                <div class="form-group{{ $errors->has('company') ? ' has-error': ''}}">
                    <fieldset>
                        <input class="form-control m-b col-md-3"  placeholder="شرکت" type="text" name="company" value="{{$work->company}}" tabindex="1"
                               required autofocus>
                    </fieldset>
                ...
                <div class="form-group{{ $errors->has('about') ? ' has-error': ''}}">
                    <fieldset>
                        <textarea style="width: 500px; height: 100px;" placeholder="توضیحات" type="text" name="about" tabindex="1"
