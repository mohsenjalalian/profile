        ...
        <div class="container">
            ...
            <form id="contact" action="{{route('blog.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('title') ? ' has-error': ''}}">
                    <fieldset>
                        <input placeholder="تیتر" type="text" name="title" tabindex="1"
                               value="{{ Request::old('title') ?: ''}}" required autofocus>
                    </fieldset>
                    @if($errors->has('title'))
                ...
                <div class="form-group{{ $errors->has('description') ? ' has-error': ''}}">
                    <fieldset>
                        <textarea name="description" rows="8" cols="80" placeholder="توضیحات" tabindex="1" required>{{ Request::old('description') ?: ''}}</textarea>
                    </fieldset>
                ...
                <div class="col-xs-4 pull-right">
                    <div class="form-group{{ $errors->has('date') ? ' has-error': ''}}">
                        <fieldset>
                            ...
                            <input name="date" class="input-small datepicker4"
                                   value="{{ Request::old('date') ?: ''}}" type="text">
                        </fieldset>
                        @if($errors->has('date'))
                ...
                <div class="form-group{{ $errors->has('photo1') ? ' has-error': ''}}">
                    <fieldset>
                        ...
                        <input type="file" id="file1" name="photo[]"
                               value="{{ Request::old('photo1') ?: ''}}" onchange="readURL1(this)" style="display:none" >
                ...
                <div class="form-group{{ $errors->has('photo2') ? ' has-error': ''}}">
                    <fieldset>
                        ...
                        <input type="file" id="file2" name="photo[]"
                               value="{{ Request::old('photo2') ?: ''}}" onchange="readURL2(this)" style="display:none" >
                ...
                <div class="form-group{{ $errors->has('photo3') ? ' has-error': ''}}">
                    <fieldset>
                        ...
                        <input type="file" id="file3" name="photo[]"
                               value="{{ Request::old('photo3') ?: ''}}" onchange="readURL3(this)" style="display:none" >
