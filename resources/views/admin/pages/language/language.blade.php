                    ...
                    <div class="panel-body">
                        <form id="contact" action="{{route('storeLanguage')}}" method="post">
                            ...
                            <div class="col-md-6">
                                ...
                                <fieldset>
                                    <button style="font-family: webmdesign;" class="btn btn-primary col-md-12" name="submit" type="submit" id="contact-submit" data-submit="...Sending">ارسال</button>
                                </fieldset>
                            </div>
                        </form>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td style="border: none; display: flex;">
                                            <button style="margin-top: 12px; width:30px; height: 30px;" data-toggle="modal" data-target="#myModal4"
                                                    data-href="{{route('language.edit',$language->id)}}" class="btn btn-warning edit md-trigger">
