        ...
        <div class="container">
            <form id="contact" action="{{route('storeEducation')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group{{ $errors->has('university_name') ? ' has-error': ''}}">
                    <fieldset>
                        <input placeholder="نام دانشگاه" type="text"
                               value="{{ Request::old('university_name') ?: ''}}" name="university_name" tabindex="1" required
                               autofocus>
                    </fieldset>
                ...
                <div class="form-group{{ $errors->has('field') ? ' has-error': ''}}">
                    <fieldset>
                        <input placeholder="رشته" type="text"
                               value="{{ Request::old('field') ?: ''}}" name="field" tabindex="1" required autofocus>
                    </fieldset>
                    @if($errors->has('field'))
                ...
                <div class="form-group{{ $errors->has('tendency') ? ' has-error': ''}}">
                    <fieldset>
                        <input placeholder="گرایش" type="text"
                               value="{{ Request::old('tendency') ?: ''}}" name="tendency" tabindex="1" required autofocus>
                    </fieldset>
                ...
                <div class="form-group{{ $errors->has('logo') ? ' has-error': ''}}">
                    <fieldset>
                        ...
                        <input type="file" id="file1" name="logo" value="{{ Request::old('logo') ?: ''}}" style="display:none"/>
                    </fieldset>
                    @if($errors->has('logo'))
                ...
                <div class="col-xs-6 pull-right">
                    <div class="form-group{{ $errors->has('start_date') ? ' has-error': ''}}">
                        <fieldset>
                            ...
                            <input name="start_date" class="input-small datepicker4"
                                   value="{{ Request::old('start_date') ?: ''}}" type="text">
                        </fieldset>
                    ...
                    <div class="form-group{{ $errors->has('finish_date') ? ' has-error': ''}}">
                        <fieldset>
                            ...
                            <input name="finish_date"
                                   value="{{ Request::old('finish_date') ?: ''}}" class="input-small datepicker4" type="text">
                        </fieldset>
