                        ...
                        <div class="panel-body">
                            <form id="contact" action="{{route('storeCertificate')}}" method="post"
                                ...
                                <div class="form-group{{ $errors->has('info') ? ' has-error': ''}}">
                                    <div class="col-sm-10 col-md-12">
                                        <textarea maxlength="360" class="demo" oninvalid="return chek(this)" oninput="return chek2(this)" style="max-width: 280px; width: 275px; height: 70px; max-height: 70px;" type="text" placeholder="توضیحات" class="form-control m-b" name="info"
