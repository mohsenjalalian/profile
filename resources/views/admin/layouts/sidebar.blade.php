                ...
                <div class="dropdown profile-element"> <span>
                            ...
                            <p class="text-center">
                                  <img alt="{{$profiles->photo}}" style="width: 100px; height:100px"
                                       class="img-circle" src="{{asset($profiles->photo)}}"/></p>
                                @else
                                  <p class="text-center"> <img alt="image/admin.png" style="width: 100px; height:100px" class="img-circle"
                                                               src="{{asset('/image/admin.png')}}"/></p>
                        @endif
                             </span>
