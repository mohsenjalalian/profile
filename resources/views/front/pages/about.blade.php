...
تهران
        ...
        @else
            <h2>درباره من</h2>
            <p class="text-justify mCustomScrollbar content-a" data-mcs-theme="minimal-dark">
                بک گراند ذهنی من هوشمندی کسب و کار و طراحی سیستم های اطلاعاتی است، ایجاد محیطی پویا، یادگیری روز افزون آمال محیط کاری و شخصی من است و سعی میکنم با استفاده از هوش تعاملی و هیجانی و ایجاد ارتباط با همکاران و مخاطبانم بیشتر از آنچه به من سپرده اند انجام دهم و کمتر از آنچه به من متعهد شدند، دریافت کنم            </p>
    </section>
    <section class="col-xs-12 col-md-6 pull-left">
        <div class="box">
            <p>اطلاعات شخصی</p>
