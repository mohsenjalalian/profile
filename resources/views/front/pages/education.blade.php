    ...
    <section class="container">
        ...
        <aside class="col-xs-12 col-md-12">
            <div id="owl" class="owl-carousel" style="direction:ltr">
                ...
                <div class="item"><img width="100px" class="pull-left hidden-xs hidden-sm img-ed" src="{{asset($education->logo)}}" alt="un"
                                       height="100px"> <i class="fa fa-book" aria-hidden="true"></i> <br>
